      ...
      <div className="relative aspect-[453/235] w-full">
        ...
        <div className="absolute inset-0">
          ...
          >
            ...
            {secondLine ? (
              <>
                {/* Phones: the second line continues on the same line as the title
                    (the <br /> is hidden, the space keeps the words apart).
                    sm and up: the second line goes on its own line, as before. */}{" "}
